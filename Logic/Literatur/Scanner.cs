...
namespace MeisterGeister.Logic.Literatur
{
    ...
    public partial class Scanner
    {
        ...
        public Scanner()
        {
            ...
            regex = new Regex(@"(Errata|ERRATA)", RegexOptions.Compiled);
            Patterns.Add(TokenType.ERRATA, regex);
            Tokens.Add(TokenType.ERRATA);
            ...
            Patterns.Add(TokenType.BIS, regex);
            Tokens.Add(TokenType.BIS);
