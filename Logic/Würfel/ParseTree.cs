...
namespace MeisterGeister.Logic.Würfel
{
    ...
    public partial class ParseNode
    {
        ...
        internal object Eval(ParseTree tree, params object[] paramlist)
        {
            ...
            switch (Token.Type)
            {
                case TokenType.Start:
                    ...
                    break;
                case TokenType.AddExpression:
                    Value = EvalAddExpression(tree, paramlist);
                    break;
                case TokenType.Atom:
        ...
        {
            if(this.GetValue(tree, TokenType.AddExpression, 0, paramlist) == null)
        		return 0;
        	return this.GetValue(tree, TokenType.AddExpression, 0, paramlist);
        }

        protected virtual object EvalAddExpression(ParseTree tree, params object[] paramlist)
        {
            int ergebnis = 0;
        	ergebnis = Convert.ToInt32(this.GetValue(tree, TokenType.Atom, 0, paramlist));
        	int i = 1;
        	while (this.GetValue(tree, TokenType.Atom, i, paramlist) != null) { 
        		if(this.GetValue(tree, TokenType.PLUSMINUS, i-1, paramlist).ToString() == "+")
        			ergebnis += Convert.ToInt32(this.GetValue(tree, TokenType.Atom, i++, paramlist)); 
        		else
        			ergebnis -= Convert.ToInt32(this.GetValue(tree, TokenType.Atom, i++, paramlist)); 
        	} 
        	return ergebnis;
