    ...
    public static class Einstellungen
    {
        ...
        private static List<Model.Einstellung> GetDefaults()
        {
            return new List<Model.Einstellung>()
            {
                ...
                new Model.Einstellung() { Name = "HUE_GatewayID", Kontext = "Allgemein", Kategorie = null, Typ = "String", Beschreibung = "HUE Lampen-Steuerung zu MeisterGeister - Gateway ID", Wert = null },
