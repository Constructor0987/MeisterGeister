...
{
    public partial class HUE_LampeColor
    {

        public HUE_LampeColor()
        {
            HUE_LampeColorGUID = Guid.NewGuid();
        }

        public static void Delete(HUE_LampeColor a, bool batch = false)
        {
            Service.SerializationService serialization = Service.SerializationService.GetInstance(!batch);
            serialization.DeleteHUELampeColorData(a);
        }
