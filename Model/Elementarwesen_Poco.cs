...
namespace MeisterGeister.Model
{
    ...
    public partial class Elementarwesen : INotifyPropertyChanged
    {
    	...
    	///<summary>Database persistent property</summary>
    	[DataMember]
        public virtual string Wesen
        {
            get { return _wesen; }
            set
    		{ 
    			Set(ref _wesen, value);
    		}
    
        }
        private string _wesen;
        ...
        private void FixupBeschwörbares(Beschwörbares previousValue)
        {
            ...
            if (previousValue != null && ReferenceEquals(previousValue.Elementarwesen, this))
            {
                previousValue.Elementarwesen = null;
            }
    
            if (Beschwörbares != null)
            {
                Beschwörbares.Elementarwesen = this;
