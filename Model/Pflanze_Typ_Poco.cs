...
namespace MeisterGeister.Model
{
    ...
    public partial class Pflanze_Typ : INotifyPropertyChanged
    {
        ...
        {
    		OnChanged("Pflanze");
            if (previousValue != null && previousValue.Pflanze_Typ.Contains(this))
            {
                previousValue.Pflanze_Typ.Remove(this);
            }
    
            if (Pflanze != null)
            {
                if (!Pflanze.Pflanze_Typ.Contains(this))
                {
                    Pflanze.Pflanze_Typ.Add(this);
                }
