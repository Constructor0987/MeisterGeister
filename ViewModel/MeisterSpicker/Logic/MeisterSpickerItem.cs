...
namespace MeisterGeister.ViewModel.MeisterSpicker.Logic
{
    public class MeisterSpickerItem : INotifyPropertyChanged
    {
        #region //---- FELDER ----
        ...
        public MeisterSpickerItem(dynamic item, string kat)
        {
