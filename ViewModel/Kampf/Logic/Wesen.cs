...
namespace MeisterGeister.ViewModel.Kampf.Logic
{
    ...
    public class Wesen : MeisterGeister.ViewModel.Bodenplan.Logic.BattlegroundCreature
    {
        ...
        private double Apply(Mod.IModifikator mod, Type typ, double? wert)
        {
        ...
        public List<dynamic> ModifikatorenListe(Type modTyp, double? startWert, ICollection<Mod.IModifikator> mods = null)
        {
            if (mods == null)
                mods = Modifikatoren;
            if (!typeof(Mod.IModifikator).IsAssignableFrom(modTyp))
