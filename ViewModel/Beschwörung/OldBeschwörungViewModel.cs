...
{
    class OldBeschwörungViewModel : Base.ViewModelBase
    {
        ...
        public OldBeschwörungViewModel()
        ...
        private static List<string> ort = new List<string>() {
            ...
            "großes Unheiligtum (z.B. Yol-Ghurmak)",
            "kleinere Kultstätte (z.B. Opferplatz)",
            "verseuchter Ort (z.B. schwarze Lande)",
            "gut vorbereiteter Ort (z.B. Reinigung)",
            "sorgfältig ausgewählter ort (z.B. Affinität)",
