...
namespace MeisterGeister.ViewModel.Alchimie
{
 ...
 //       private bool _isEnabledAlchimistenLaborHerstellung;
        ...
        private string _modifikatorSubstitutionenHerstellung ="0";
        private string _modifikatorTaPZurückhaltenHerstellung ="0";
        private string _modifikatorCHHerstellung ="0";
        private string _bonusTaPQualitätHerstellung;
        private string _bonusCHQualitätHerstellung="0";
        private string _bonusAAQualitätHerstellung;
        private string _probenModGesHerstellung;
        private string _herstellungWirkungM;
        private string _aSPEinsatzHerstellung="0";
 ...
 //       public List<Zutat> SubstitutionListeHerstellung { get { return _substitutionListeHerstellung; } set { _substitutionListeHerstellung = value; OnChanged("SubstitutionListeHerstellung"); calculateModSubstitutionen(); } }
        ...
        public Alchimierezept SelectedRezeptHerstellung { get { return _selectedRezeptHerstellung; } set { _selectedRezeptHerstellung = value; OnChanged("SelectedRezeptHerstellung"); SubstitutionListeHerstellung = getZutatenByRezept(value); HerstellungWirkungM = getMWirkung(); calculateProbenModGes(); } }
        public string SelectedLaborArtListeHerstellung { get { return _selectedLaborArtListeHerstellung; } set { _selectedLaborArtListeHerstellung = value; OnChanged("SelectedLaborArtListeHerstellung"); calculateModLab(); calculateProbenModGes(); } }
        public string SelectedLaborQualitätListeHerstellung { get { return _selectedLaborQualitätListeHerstellung; } set { _selectedLaborQualitätListeHerstellung = value; OnChanged("SelectedLaborQualitätListeHerstellung"); calculateModLab(); calculateProbenModGes(); } }
        //Rückgaben
        public int WertTaWTalent { get { return _wertTaWTalent; } set { _wertTaWTalent = value; OnChanged("WertTaWTalent"); } }
        public int WertTaPZurückhaltenHerstellung { get { return _wertTaPZurückhaltenHerstellung; } set { if (SelectedRezeptHerstellung!=null && Convert.ToInt32(value) >= 0 && Convert.ToInt32(value) <= SelectedRezeptHerstellung.Brauschwierigkeit) { _wertTaPZurückhaltenHerstellung = value; OnChanged("WertTaPZurückhaltenHerstellung"); ModifikatorTaPZurückhaltenHerstellung = _wertTaPZurückhaltenHerstellung.ToString(); BonusTaPQualitätHerstellung = _wertTaPZurückhaltenHerstellung.ToString(); } } }
        public int WertAstralesAufladenHerstellung { get { return _wertAstralesAufladenHerstellung; } set {
            if (value >= 0) {
            _wertAstralesAufladenHerstellung = value;
            if (value == 0 || value == 1) { BonusAAQualitätHerstellung = value.ToString(); if (CheckedChymischeHochzeitHerstellung) ASPEinsatzHerstellung = (Math.Ceiling(((double)value)/2)).ToString(); else ASPEinsatzHerstellung = value.ToString(); }
            else if (((Math.Log10(value) / Math.Log10(2.0)) % 1) == 0) { BonusAAQualitätHerstellung = ((Math.Log10(value) / Math.Log10(2.0)) + 1).ToString(); if (CheckedChymischeHochzeitHerstellung) ASPEinsatzHerstellung = (Math.Ceiling(((double)value) / 2)).ToString(); else ASPEinsatzHerstellung = value.ToString(); }
        ...
        public string ModifikatorSubstitutionenHerstellung { get { return _modifikatorSubstitutionenHerstellung; } set { _modifikatorSubstitutionenHerstellung = value; OnChanged("ModifikatorSubstitutionenHerstellung"); } }
        public string ProbenModGesHerstellung { get { return _probenModGesHerstellung; } set { _probenModGesHerstellung = value; OnChanged("ProbenModGesHerstellung"); } }
        public string HerstellungWirkungM { get { return _herstellungWirkungM; } set { _herstellungWirkungM = value; OnChanged("HerstellungWirkungM"); } }
        public string ModifikatorTaPZurückhaltenHerstellung { get { return _modifikatorTaPZurückhaltenHerstellung; } set { if (Convert.ToInt32(value) >= 2) { _modifikatorTaPZurückhaltenHerstellung = value; } else _modifikatorTaPZurückhaltenHerstellung = "0"; OnChanged("ModifikatorTaPZurückhaltenHerstellung"); calculateProbenModGes(); } }
        public string ModifikatorCHHerstellung { get { return _modifikatorCHHerstellung; } set { _modifikatorCHHerstellung = value; OnChanged("ModifikatorCHHerstellung"); } }
        public string BonusTaPQualitätHerstellung { get { return _bonusTaPQualitätHerstellung; } set { if (Convert.ToInt32(value) >= 2) { _bonusTaPQualitätHerstellung = (Convert.ToInt32(value) * 2).ToString(); } else _bonusTaPQualitätHerstellung = "0"; OnChanged("BonusTaPQualitätHerstellung"); calculateQualiModGes(); } }
        public string BonusCHQualitätHerstellung { get { return _bonusCHQualitätHerstellung; } set { _bonusCHQualitätHerstellung = value; OnChanged("BonusCHQualitätHerstellung"); calculateQualiModGes(); } }
        public string BonusAAQualitätHerstellung { get { return _bonusAAQualitätHerstellung; } set { _bonusAAQualitätHerstellung = (Convert.ToInt32(value)).ToString(); OnChanged("BonusAAQualitätHerstellung"); calculateQualiModGes(); } }
        public string ASPEinsatzHerstellung { get { return _aSPEinsatzHerstellung; } set { _aSPEinsatzHerstellung = value; OnChanged("ASPEinsatzHerstellung"); } }
        public string BonusQualitätHerstellung { get { return _bonusQualitätHerstellung; } set { _bonusQualitätHerstellung = value; OnChanged("BonusQualitätHerstellung"); } }

        //Checkboxen
        public bool CheckedChymischeHochzeitHerstellung { get { return _checkedChymischeHochzeitHerstellung; } set { _checkedChymischeHochzeitHerstellung = value; OnChanged("CheckedChymischeHochzeitHerstellung"); if (value) { ModifikatorCHHerstellung = "-1"; BonusCHQualitätHerstellung = "2"; } else { ModifikatorCHHerstellung = "0"; BonusCHQualitätHerstellung = "0"; } WertAstralesAufladenHerstellung = WertAstralesAufladenHerstellung; calculateProbenModGes(); } }
        ...
        private void calculateModSubstitutionen()
        {
            ...
            {
                if (z.mod == "nicht möglich")
                {
                    ModifikatorSubstitutionenHerstellung = z.mod;
                    return;
                }
                mod = mod+Convert.ToInt32(z.mod);
            }
            ModifikatorSubstitutionenHerstellung = mod.ToString();
        }
...
//                    zz.PropertyChanged += OnPropertyChanged;
                    zutaten.Add(zz);
                }
                return zutaten;
            }
        ...
        {
            if (ModifikatorSubstitutionenHerstellung == "nicht möglich" || ModifikatorLaborHerstellung == "nicht möglich")
            {
                ProbenModGesHerstellung = ModifikatorSubstitutionenHerstellung;
                return;
            }
            else
            {
                int mod = SelectedRezeptHerstellung.Brauschwierigkeit;
                if (CheckedChymischeHochzeitHerstellung) mod -= 1;
                mod += Convert.ToInt32(ModifikatorTaPZurückhaltenHerstellung);
                mod += Convert.ToInt32(ModifikatorSubstitutionenHerstellung);
                mod += Convert.ToInt32(ModifikatorLaborHerstellung);
                ProbenModGesHerstellung = mod.ToString();
                return;
            }
        }
        ...
        private void calculateQualiModGes()
        {
            if (ModifikatorSubstitutionenHerstellung == "nicht möglich" || ModifikatorLaborHerstellung == "nicht möglich")
            {
                BonusQualitätHerstellung = ModifikatorSubstitutionenHerstellung;
                return;
            }
            else
            {
                int mod = 0;
                if (CheckedChymischeHochzeitHerstellung) mod += Convert.ToInt32(BonusCHQualitätHerstellung);
                mod += Convert.ToInt32(BonusTaPQualitätHerstellung);
                mod += Convert.ToInt32(BonusAAQualitätHerstellung);
        ...
        private string getMWirkung()
        {
            ...
            return wirkungen[(int)Math.Round(rndm.NextDouble() * (double)wirkungen.Count)];
        }
 ...
 /*       private void OnPropertyChanged(object sender, PropertyChangedEventArgs e)
        ...
        {"Das Mittel hat keinerlei Wirkung",
         ...
         "Das fertige Elixie hat egenau die Gegenteilige Wirkung eines gelungenen. Würfeln Sie 1W20 um die Qualität zu bestimmen (1-5: A; 6-10: B; 11-14: C; 15-17: D; 18-19: E; 20: F) und drehen Sie die Wirkung um. Würde ein Trank 3W6 LeP zurückgeben, so verursacht er dieselbe Menge an Schade.",
         ...
         "Der Anwender ist für einen Tag vollJkommen desorientiert (AT/PA, Fernkampf -4, KL/FF/GE -2; keine weiteren Auswirkungen auf die abgeleiteten Grundwerte).",
         "Der Anwender fällt für 5W6 Stunden in einen Tiefschlaf ohne jede Heilwirkung (Regeneration entfällt).",
         "Nach der Anwendung vermag der Betroffene selbst bei größter Müdigkeit für 1W6 Nächte keinen Schlaf zu finden (in der ersten Nacht zwei Punkte Erschöpfung, in der zweiten drei Punkte, in der dritten vier Punktc usw.).",
         "Der Betroffene wird für 1W20 KR zum Berserker (siehe Qualität C des Berserkerelixiers, Seite 59).",
         ...
         "Eine (oder mehrere) passende Schlechte Eigenschaft steigt für 3W6 Stunden um 2W6 Punkte (anschließend besteht eine Chance von 10 % (19 bis 20 auf IW20), dass die Schlechte Eigenschaft permanent um einen Punkt steigt).",
         "Die Anwendung führt für lW6 Stunden zu einer gichtartigen Lähmung der Finger (FF halbiert, min. -7).",
         "Der Anwender wird für lW6 Stunden so gewandt, als wenn er sich in Thorwaler Rübenbrei bewegen würde (GE halbiert, min. -7).",
         "Der Anwender erhält für 3W6 Stunden das Einfuhlungs- und Reaktionsvermögen eines Stalagmiten (IN halbiert, min. -7).",
         ...
         "Der Anwender ist für 1W20 Stunden schlapp wie tulamidiseher Weichkäse, reagiert auf körperliche Beanspruchung überempfindlich und bekommt bereits blaue Flecken, wenn man ihn nur anstupst (KO halbiert, min. -7, AU auf 0).",
